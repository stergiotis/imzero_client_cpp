...
case 0x00000001:
  {
    FFFI_FUNCTION_INVOCATION("ColoredButtonV")
    auto label = receiveString();
    auto size = receiveArray<float,2>();
    auto text_color = receiveValue<uint32_t>();
    auto bg_color1 = receiveValue<uint32_t>();
    auto bg_color2 = receiveValue<uint32_t>();
    bool r;
    {
    r = ImGui::ColoredButtonV1(label,size,text_color,bg_color1,bg_color2);;
    sendEmptyString();
    sendValue<bool>(r);
    flushSend();
  }
...
case 0x00000007:
  {
    FFFI_FUNCTION_INVOCATION("GetContentRegionMaxAbs")
    float* r;
    {
    auto r = ImGui::GetContentRegionMaxAbs();
    sendEmptyString();
    sendArray<float,2>(r);
    flushSend();
  }
...
case 0x00000073:
  {
    ...
    auto foreignptr = receiveValue<uintptr_t>();
    auto center = receiveArray<float,2>();
    auto radius_x = receiveValue<float>();
    auto radius_y = receiveValue<float>();
    auto col = receiveValue<uint32_t>();
    {
    ((ImDrawList*)foreignptr)->AddEllipse(center, radius_x, radius_y, col);
  }
  }
  break;
case 0x00000074:
  {
    ...
    auto thickness = receiveValue<float>();
    {
    ((ImDrawList*)foreignptr)->AddEllipse(center, radius_x, radius_y, col, rot, num_segments, thickness);
  }
  }
  break;
case 0x00000075:
  {
    ...
    auto col = receiveValue<uint32_t>();
    {
    ((ImDrawList*)foreignptr)->AddEllipseFilled(center, radius_x, radius_y, col);
  }
  }
  break;
case 0x00000076:
  {
    ...
    auto num_segments = receiveValueSignMagnitude<int>();
    {
    ((ImDrawList*)foreignptr)->AddEllipseFilled(center, radius_x, radius_y, col, rot, num_segments);
  }
  }
  break;
case 0x00000077:
...
case 0x000000a1:
  {
    ...
    auto glyphExtraSpacing = receiveArray<float,2>();
...
case 0x000000f9:
  {
    FFFI_FUNCTION_INVOCATION("PushTabStop")
    auto tab_stop = receiveValue<bool>();
    {
...
case 0x000000fa:
  {
    FFFI_FUNCTION_INVOCATION("PopTabStop")
    {
    ImGui::PopTabStop();
  }
  }
...
case 0x000000fb:
  {
    FFFI_FUNCTION_INVOCATION("PushButtonRepeat")
...
case 0x000000fc:
  {
    FFFI_FUNCTION_INVOCATION("PopButtonRepeat")
    {
...
case 0x0000016d:
  {
    ...
    auto str_id = receiveString();
    auto column = receiveValueSignMagnitude<int>();
    bool r;
    {
    auto r = ImGui::BeginTable(str_id, column);
    sendEmptyString();
    sendValue<bool>(r);
    flushSend();
  }
...
case 0x0000016e:
  {
    ...
    bool r;
    {
    auto r = ImGui::BeginTable(str_id, column, flags, outer_size, inner_width);
    sendEmptyString();
    sendValue<bool>(r);
    flushSend();
  }
...
case 0x000001fa:
  {
    FFFI_FUNCTION_INVOCATION("ImageButtonOld")
    auto user_texture_id = receiveValue<uintptr_t>();
    auto size = receiveArray<float,2>();
    bool r;
    {
...
case 0x000001fb:
  {
    FFFI_FUNCTION_INVOCATION("ImageButtonVOld")
    auto user_texture_id = receiveValue<uintptr_t>();
    auto size = receiveArray<float,2>();
    auto uv0 = receiveArray<float,2>();
    auto uv1 = receiveArray<float,2>();
    auto frame_padding = receiveValueSignMagnitude<int>();
    auto bg_col = receiveArray<float,4>();
    auto tint_col = receiveArray<float,4>();
    bool r;
    {
...
case 0x0000024a:
  {
    ...
    {
    ImSpinner::SpinnerRainbow(label, radius, thickness, color, speed, ang_min, ang_max, arcs);
  }
  }
  break;
case 0x0000024b:
...
case 0x00000258:
  {
    ...
    {
    ImSpinner::SpinnerPulsar(label, radius, thickness, bg, speed, sequence);
  }
  }
  break;
case 0x00000259:
...
case 0x0000025a:
  {
    ...
    {
    ImSpinner::SpinnerTwinPulsar(label, radius, thickness, color, speed, rings);
  }
  }
  break;
case 0x0000025b:
...
case 0x0000025c:
  {
    ...
    auto rings = receiveValueSignMagnitude<int>();
    {
    ImSpinner::SpinnerFadePulsar(label, radius, color, speed, rings);
  }
  }
  break;
case 0x0000025d:
...
case 0x0000025e:
  {
    ...
    {
    ImSpinner::SpinnerCircularLines(label, radius, color, speed, lines);
  }
  }
  break;
case 0x0000025f:
...
case 0x00000260:
  {
    ...
    {
    ImSpinner::SpinnerVDots(label, radius, thickness, color, bgcolor, speed, dots, mdots);
  }
  }
  break;
case 0x00000261:
...
case 0x00000282:
  {
    ...
    auto angle = receiveValue<float>();
    {
    ImSpinner::SpinnerTwinAng(label, radius1, radius2, thickness, color1, color2, speed, angle);
  }
  }
  break;
case 0x00000283:
...
case 0x00000288:
  {
    ...
    auto speed = receiveValue<float>();
    {
    ImSpinner::SpinnerTwinAng180(label, radius1, radius2, thickness, color1, color2, speed);
  }
  }
  break;
case 0x00000289:
...
case 0x00000292:
  {
    ...
    auto scale = receiveValue<bool>();
    {
    ImSpinner::SpinnerFadeTris(label, radius, color, speed, dim, scale);
  }
  }
  break;
case 0x00000293:
...
case 0x0000029c:
  {
    ...
    auto arcs = receiveValue<uint64_t>();
    {
    ImSpinner::SpinnerArcFade(label, radius, thickness, color, speed, arcs);
  }
  }
  break;
case 0x0000029d:
...
case 0x000002b6:
  {
    ...
    auto arcs = receiveValue<uint64_t>();
    {
    ImSpinner::SpinnerArcWedges(label, radius, color, speed, arcs);
  }
  }
  break;
case 0x000002b7:
...
case 0x000002b8:
  {
    ...
    {
    ImSpinner::SpinnerTwinBall(label, radius1, radius2, thickness, b_thickness, ball, bg, speed, balls);
  }
  }
  break;
case 0x000002b9:
...
case 0x000002c8:
  {
    ...
    auto dots = receiveValue<uint64_t>();
    {
    ImSpinner::SpinnerIncScaleDots(label, radius, thickness, color, speed, dots);
  }
  }
  break;
case 0x000002c9:
...
case 0x000002d0:
  {
    ...
    auto angle = receiveValue<float>();
    {
    ImSpinner::SpinnerIngYang(label, radius, thickness, reverse, yang_detlta_r, colorI, colorY, speed, angle);
  }
  }
  break;
case 0x000002d1:
...
case 0x000002e7:
  {
    ...
    {
    ImSpinner::SpinnerRotateSegments(label, radius, thickness, color, speed, arcs, layers);
  }
  }
  break;
case 0x000002e8:
...
case 0x000002fb:
  {
    ...
    auto elipses = receiveValueSignMagnitude<int>();
    {
    ImSpinner::SpinnerRotatedAtom(label, radius, thickness, color, speed, elipses);
  }
  }
  break;
case 0x000002fc:
...
case 0x000002fd:
  {
    ...
    auto balls = receiveValueSignMagnitude<int>();
    {
    ImSpinner::SpinnerRainbowBalls(label, radius, thickness, color, speed, balls);
  }
  }
  break;
case 0x000002fe:
...
case 0x0000030b:
  {
    ...
    auto bars = receiveValueSignMagnitude<int>();
    {
    ImSpinner::SpinnerBarChartRainbow(label, radius, thickness, color, speed, bars);
  }
  }
  break;
case 0x0000030c:
...
case 0x00000318:
  {
    ...
    auto arcs = receiveValue<uint64_t>();
    {
    ImSpinner::SpinnerArcPolarFade(label, radius, color, speed, arcs);
  }
  }
  break;
case 0x00000319:
...
case 0x0000031a:
  {
    ...
    auto arcs = receiveValue<uint64_t>();
    {
    ImSpinner::SpinnerArcPolarRadius(label, radius, color, speed, arcs);
  }
  }
  break;
case 0x0000031b:
...
case 0x0000031e:
  {
    ...
    auto dots = receiveValue<uint64_t>();
    {
    ImSpinner::SpinnerHboDots(label, radius, thickness, color, minfade, ryk, speed, dots);
  }
  }
  break;
case 0x0000031f:
...
;
    ...
    sendSlice<int>(directions,directions_len);
    flushSend();
  }
  }
  break;
